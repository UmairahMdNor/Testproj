...
public class School_Information {
	 ...
	 // JDBC driver name and database URL
	   ...
	   static final String USER = "Umairah";
	   static final String PASS = "lily0409";
	/**
	 * @param args
	 */
			...
			if (choice.equalsIgnoreCase("1") || choice.equalsIgnoreCase("view") ) {
				...
				try {
				      ...
				      System.out.println("--------------------------------------------------------------");
					      ...
					      System.out.println("|Subejct   | credit_hour      |");
					      System.out.println("-------------------------------");
					      while(rs.next()){
					         //Retrieve by column name
					      ...
					      System.out.println("-------------------------------");
						   ...
						   System.out.println("Name   |  Subejct     | Grade	| Status	|");
						   System.out.println("-----------------------");
					      ...
					      while(rs.next()){
					         ...
					         //Display values;
					         System.out.println(name +"           |"+ subject+ "         |" + grade +"			|" + status +"			|"	);
					      }  
					      System.out.println("-----------------------");
					   }
				      rs.close();
